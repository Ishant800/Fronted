                    ...
                    <div className="p-10">
                        ...
                        <form action="" className="mt-10">
                            ...
                            <div className="mt-7 w-full">
                                <button className="text-lg capitalize w-full p-3 rounded-md font-medium bg-blue-500 text-white">Signu up</button>
                            </div>
                            <div className="mt-3 flex justify-center ">
                                <a className=" text-center text-gray-800 font-medium text-md">already have an account <span className="text-blue-400 font-medium">signin</span></a>
